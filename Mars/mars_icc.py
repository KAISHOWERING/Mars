...
#0.2 导入参数
with open(current_path + "/mars_var.json","r+") as f:
    mars_var = json.load(f)

lib_name = mars_var["mv_lib_name"]
top_name = mars_var["mv_top_name"]

with open(current_path + "/mars_pin.json","r+") as f:
