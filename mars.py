...
# 读原始文件
f1 = open('/export/home/linyukai/Documents/Mars/DC/setup/common_setup.tcl','r+')
...
# 读原始文件
f1 = open('/export/home/linyukai/Documents/Mars/DC/setup/dc_setup.tcl','r+')
...
# 读原始文件
f1 = open('/export/home/linyukai/Documents/Mars/DC/setup/dc_setup_filenames.tcl','r+')
# 不做处理，直接复制
for ss in f1.readlines():
    f2.write(ss)
f1.close()
...
# 读原始文件
f1 = open('/export/home/linyukai/Documents/Mars/DC/dc_scripts/dc.dft_autofix_config.tcl','r+')
# 不做处理，直接复制
for ss in f1.readlines():
    f2.write(ss)
f1.close()
...
# 读原始文件
f1 = open('/export/home/linyukai/Documents/Mars/DC/dc_scripts/fm.tcl','r+')
...
f2 = open(new_fm_tcl,'w+')
# 读原始文件
f1 = open('/export/home/linyukai/Documents/Mars/DC/dc_scripts/dc.tcl','r+')
...
f2 = open(new_sdc,'w+')
# 读原始文件
f1 = open('/export/home/linyukai/Documents/Mars/SDC/systolic_pe_array.sdc','r+')
